...
VALUES ('Nema pusenja', 2, 0, false, 'Vikendica na Kopaoniku', 0, 2000, 'Odlicna vikendica', 1, 4, 2);

INSERT INTO public.house(
    behaviour_rules, cancalletion_fee, grade, is_cancalletion_free, name, number_of_reviews, price_per_day, promo_description, version, address_id, owner_id)
VALUES ('Nema kasnjena', 4, 0, false, 'Vikendica na Zlatiboru', 0, 2000, 'Odlicna vikendica', 1, 5, 2);

INSERT INTO public.house(
    behaviour_rules, cancalletion_fee, grade, is_cancalletion_free, name, number_of_reviews, price_per_day, promo_description, version, address_id, owner_id)
VALUES ('Nema galame poslije 12', 3, 0, false, 'Vikendica na Tari', 0, 2000, 'Odlicna vikendica', 1, 12, 2);

INSERT INTO public.house(
    behaviour_rules, cancalletion_fee, grade, is_cancalletion_free, name, number_of_reviews, price_per_day, promo_description, version, address_id, owner_id)
VALUES ('Nema kupanja u reci!', 5, 0, false, 'Kuća na Dunavu', 0, 3000, 'Odlicna vikendica', 1, 11, 6);

INSERT INTO public.house(
    behaviour_rules, cancalletion_fee, grade, is_cancalletion_free, name, number_of_reviews, price_per_day, promo_description, version, address_id, owner_id)
VALUES ('Nema bacanja smeća u šumu!', 0, 0, true, 'Fruškogorska bajka', 0, 4500, 'Odlicna vikendica', 2, 10, 6);
...
INSERT INTO public.boat(
    behaviour_rules, cancalletion_fee, capacity, engine_number, engine_power, fishing_equipment, grade, is_cancalletion_free, length, max_speed, name, number_of_reviews, price_per_day, promo_description, type, version, address_id, navigation_equipment_id, owner_id)
VALUES ('Nema alkohla na brodu', 5, 10, 45645, 100, 'stapovi', 0, false, 100, 20, 'Kruzer na Mlavi', 0, 4000, 'Odlican brod', 'Kruzer', 1, 8, 2, 8);

INSERT INTO public.boat(
    behaviour_rules, cancalletion_fee, capacity, engine_number, engine_power, fishing_equipment, grade, is_cancalletion_free, length, max_speed, name, number_of_reviews, price_per_day, promo_description, type, version, address_id, navigation_equipment_id, owner_id)
VALUES ('Nema alkohla na brodu', 3, 10, 45645, 100, 'stapovi', 0, false, 100, 20, 'Kruzer na Savi', 0, 4000, 'Odlican brod', 'Kruzer', 1, 9, 3, 8);

INSERT INTO public.image(
    image_url, boat_id, fishing_adventure_id, house_id)
VALUES ('assets/boat2.jpg', 1, null, null);
INSERT INTO public.image(
    image_url, boat_id, fishing_adventure_id, house_id)
VALUES ('assets/boat3.jpg', 2, null, null);
INSERT INTO public.image(
    image_url, boat_id, fishing_adventure_id, house_id)
VALUES ('assets/boat-inside2.jpg', 3, null, null);
INSERT INTO public.image(
    image_url, boat_id, fishing_adventure_id, house_id)
VALUES ('assets/house1.jpg', null, null, 1);
INSERT INTO public.image(
    image_url, boat_id, fishing_adventure_id, house_id)
VALUES ('assets/house2.jpg', null, null, 2);
INSERT INTO public.image(
    image_url, boat_id, fishing_adventure_id, house_id)
